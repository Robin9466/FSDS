...
def fetch_image_urls(query: str, max_links_to_fetch: int, wd: webdriver, sleep_between_interactions: int = 10):
    ...
    while image_count < max_links_to_fetch:
        ...
        # get all image thumbnail results using find_elements directly on the wd object
        ...
        for img in thumbnail_results[results_start:number_results]:
            ...
            if results_start >= number_results:
                break  # No more results to load, exit the loop
...
DRIVER_PATH = r'C:\Downloads\chromedriver.exe'
search_term = 'robin raj'
